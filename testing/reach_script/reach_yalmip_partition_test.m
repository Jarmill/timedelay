%reachable set analysis with space partitions
...
Npartition = 4;
boxlim_cell_all = linspace(-boxlim, boxlim, Npartition+1);
boxlim_cell = [boxlim_cell_all(1:end-1); boxlim_cell_all(2:end)];
...
[phi0, cphi0, mphi0] = polynomial([t; x], d);
...
[pOm0, consOm0, GramOm0] = psatz(phi0 + phi1_shift, Omega0, order, [t; x]);
